...
public class Func_produtividade extends Funcionario {
    ...
    //construtor
    public Func_produtividade(int unidade_produzida, double valor_unidade_produzida, String nome, String num_BI, String estado_civil, String data_nasc, String morada, String nome_pai, String nome_mae, String data_ingresso, char sexo, double altura, double salario) {
